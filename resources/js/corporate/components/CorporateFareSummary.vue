...
<!--                    <div class="cancel-caharge">Cancellation &amp; changes charges</div>-->
...
<!--                        Could not retrieve information from Airline.-->
<!--                        Our team is available 24/7 to answer your questions.-->
<!--                        <a href="tel:+97145182000" class="cancel-phone mt-2">+97145182000</a>-->
<!--                        <a href="mailto:support@tajawal.com" class="cancel-mail mt-1">support@tajawal.com</a>-->
                    </div>
                </div>
            </div>
        </div>
...
<script>
    export default {
        name: "CorporateFareSummary",
        props: ["Itinerary"],
        data() {
          return {}
        },
        mounted() {
            console.log("CorporateFareSummary component mounted");
        },
        methods: {
            LoadFareRules(FareDetails, Option) {
                this.$parent.$parent.loader = true;
                window.axios.get(base_url + 'corporate/flight/load_fare_rules', {
                    params: {
