...
<div id="wrapper">
    ...
    <section class="m-0" data-background-delay="3500" data-background-fade="1000"
             data-background="../images/airport.jpg,../images/plane.jpg"
        ...
        <div class="container z-index-1">
            <div class="row">
                ...
                <div class="col-lg-6 col-md-6 col-xs-12 order-lg-2 order-md-2 text-md-right text-sm-center text-xs-center">
                    <h1 class="m-0 fs-40 fw-400 text-white wow fadeInUp animated animated" data-wow-delay="0.4s"
                        style="visibility: visible; animation-delay: 0.4s; animation-name: fadeInUp;">{{$corporate->name}}
                        LTD</h1>
                    <p class="lead fs-16 fw-300 text-white wow fadeInUp animated animated" data-wow-delay="0.7s"
                       style="visibility: visible; animation-delay: 0.7s; animation-name: fadeInUp;">WELCOME TO
                        TRAVELDESK</p>
                </div>
                ...
                <div class="col-lg-6 col-md-6 col-md-6 col-xs-12 order-lg-1 order-md-1 mb-0">
                    <div class="login-box p-20">
                        ...
                        @endif
                        <form class="m-0" method="post" action="{{url('corporate/reset_password')}}" autocomplete="off">
                            {{csrf_field()}}
                            <input hidden name="corporate_name" value="{{strtolower($corporate->alais)}}">
                            <div class="clearfix">
                                <!-- Email -->
                            ...
                            <div class="row">
                                <div class="col-md-6 col-sm-6 col-xs-6">
                                    ...
                                    <div class="form-tip pt-20">
                                        <a class="no-text-decoration fs-13 mt-10 block" href="{{url('corporate/'.$corporate->alais)}}">Back to Login</a>
                                    </div>
                                </div>
                                <div class="col-md-6 col-sm-6 col-xs-6 text-right">
                                    <button class="btn btn-primary">OK, SEND PASSWORD</button>
                                </div>
                            </div>
                        </form>
                    </div>
