                      ...
                      <div class="border title_sub" style="border-radius:3px; padding:10px;">
                        ...
                        <div class="row">
                            <div class="col-md-3">
                                ...
                                <input required name="employee[employeecode]"
                            ...
                            <div class="col-md-3">
                                ...
                                <select required name="employee[employee_type]" id="" class="form-control">
                            ...
                            <div class="col-md-3">
                                ...
                                <select id="PointOfHire"  type="text" name="employee[point_of_hire]"
                                       value="{{!empty($employee->point_of_hire) ? $employee->point_of_hire : '' }}"
                                        class="form-control" placeholder="Type Departure City"></select>
                            </div>
                            <div class="col-md-3">
                                <label for="">Create Own Trip <span class="text-danger">*</span></label>
                                <div class="d-flex">
                                    <input type="radio" checked  name="employee[create_own_trip]" {{!empty($employee->create_own_trip) ? "checked" : "" }} value="1" id="" class="mr-20">
                                    <label for="">Yes</label>
                                    <input type="radio" name="employee[create_own_trip]" {{!empty($employee->create_own_trip) ? "" : "checked" }} id="" value="0" class="mx-3">
                                    <label for="">No</label>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-3">
                                ...
                                <select required name="employee[salutation]" id="" class="form-control">
                        ...
                        <div class="row">
                            <div class="col-md-3">
                                ...
                                <select required name="employee[corporate_branchid]" id="" class="form-control">
                                    @foreach($branch as $b)
                            ...
                            <div class="col-md-3">
                                ...
                                <select required name="employee[department]" id="" class="form-control">
                            ...
                            <div class="col-md-3">
                                ...
                                <select required name="employee[designation]" id="" class="form-control">
                            ...
                            <div class="col-md-3">
                                ...
                                <div class="d-flex">
                                    <select required name="employee[day]" id="empbirthdate" class="form-control mr-10">
                                        @for($x =1; $x <=31; $x++)
                                            <option value="{{ $x }}">{{ $x }}</option>
                                        @endfor
                                    </select>
                                    <select required name="employee[month]" id="" class="form-control empbirthdate">
                                        @for($x =1; $x <=12; $x++)
                                            <option value="{{ $x }}">{{ $x }}</option>
                                        @endfor
                                    </select>
                                    <select required name="employee[year]" id="empbirthmonth" class="form-control ml-10">
                                        @for($i =$now; $i > 1920; $i--)
                        ...
                        <div class="row">
                            <div class="col-md-3">
                                ...
                                <select required name="employee[country_of_residence]" id="" class="form-control">
                            ...
                            <div class="col-md-3">
                                ...
                                <select required name="employee[costcentreid]" id="" class="form-control">
                            ...
                            <div class="col-md-3">
                                ...
                                <div class="d-flex">
                                    <label for="">
                                        <input type="radio"
                                               {{!empty($employee->costenable)?'checked':''}} name="employee[costenable]"
                                               value="1" class="mr-20"> Enable</label>
                                    <label for="">
                                        <input type="radio" name="employee[costenable]"
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                ...
                                <input type="text" name="employee[personalemailid]"
                            ...
                            <div class="col-md-3">
                                ...
                                <div class="row no-gutters">
                                    <div class="col-md-4 col-4 pr-10">
                                        <input type="text"  name="employee[phonecode]" value="{{!empty($employee->phone_country_code) ? $employee->phone_country_code : '' }}" class="form-control">
                                    </div>
                                    <div class="col-md-8 col-8">
                                        <input type="text" name="employee[phonenumber]"
                                               value="{{!empty($employee->phonenumber) ? $employee->phonenumber : '' }}"
                                               class="form-control">
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-3">
                                ...
                                <div class="row no-gutters">
                                    <div class="col-md-4 col-4 pr-10">
                                        <input type="text" name="employee[mobilecode]" value="{{!empty($employee->mobile_country_code) ? $employee->mobile_country_code : '' }}" class="form-control">
                                    </div>
                                    <div class="col-md-8 col-8">
                                        <input type="text" name="employee[mobilenumber]"
                                               value="{{!empty($employee->mobile_corporate) ? $employee->mobile_corporate : '' }}"
                                               class="form-control">
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-3">
                                ...
                                <div class="row no-gutters">
                                    <div class="col-md-4 col-4 pr-10">
                                        <input type="text" name="employee[personalphonecode]" value="{{!empty($employee->personal_country_code) ? $employee->personal_country_code : '' }}"
                                               class="form-control">
                                    </div>
                                    <div class="col-md-8 col-8">
                                        <input type="text" name="employee[personalphonenumber]"
                                               value="{{!empty($employee->mobile_personal) ? $employee->mobile_personal : '' }}"
                                               class="form-control">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-3">
                                ...
                                <div class="row no-gutters">
                                    <div class="col-md-4 col-4 pr-10">
                                        <input type="text" name="employee[emergency_contact_code]" value="{{!empty($employee->emergency_country_code) ? $employee->emergency_country_code : '' }}"
                                               class="form-control">
                                    </div>
                                    <div class="col-md-8 col-8">
                                        <input type="text" name="employee[emergency_contact_number]"
                                               value="{{!empty($employee->emergencycontactno) ? $employee->emergencycontactno : '' }}"
                                               class="form-control">
                                    </div>
                                </div>
                            </div>
            ...
            <div class="credit-info mt-20">
                ...
                <div class="row">
                    <div class="col-md-3">
                        ...
                        <select required name="employee[policy_id]" id="" class="form-control">
                    ...
                    <div class="col-md-3">
                        ...
                        <div class="d-flex">
                            <input type="radio" {{!empty($employee->allow_personal_travel) ? "checked" : "" }} name="employee[allow_personal_travel]" id="" class="mr-20">
                            <label for="">Yes</label>
                            <input type="radio" {{!empty($employee->allow_personal_travel) ? "" : "checked" }}  name="employee[allow_personal_travel]" id="" class="mx-3">
                            <label for="">No</label>
                        </div>
                    </div>
                    <div class="col-md-3">
                        ...
                        <div class="d-flex">
                            <input type="radio" checked  name="employee[role_id]" {{!empty($employee->is_approver) ? "checked" : "" }} value="Approver" id="" class="mr-20">
                            <label for="">Approver</label>
                            <input type="radio" name="employee[role_id]" {{!empty($employee->is_traveler) ? "checked" : "" }} id="" value="Traveller" class="mx-3">
                            <label for="">Traveller</label>
                            <input type="radio" name="employee[role_id]" {{!empty($employee->is_booker) ? "checked" : "" }} value="Booker" id="" class="mx-3">
                ...
                <div class="row">
                    <div class="col-md-4">
                        ...
                        <select required name="employee[workflow_id]" id="" class="form-control">
                    ...
                    <div class="col-md-4">
                        ...
                        <select required name="employee[doctor_approver]" id="" class="form-control">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="w-200">
                            <div class="d-flex justify-content-between">
                                <input checked type="radio" {{!empty($employee->isActive)?'checked':''}}  value="1"
                                       name="employee[isActive]" id="">
                                <label for="">Active</label>
                                <input type="radio" {{ !empty($employee) && empty($employee->isActive) ? 'checked' : '' }} value="0"
                                       name="employee[isActive]" id="">
...
@push('scripts')
    ...
    <script>
        $('#PointOfHire').append('<option value="{{!empty($employee->point_of_hire)?$employee->point_of_hire:""}}" selected="selected">{{!empty($employee->cityName)?$employee->cityName:""}}</option>');
        $('#PointOfHire').trigger('change');
        $('[id=PointOfHire]').select2(
            {
        ...
        $('#submit_form').on('submit', function (event) {
            ...
            var url = '{{url('corporate/employee/update')}}';
                    @else
            var url = '{{url('corporate/employee/add')}}';
                    @endif
            ...
            $.ajax({
                ...
                success: function (data) {
                    if(data.status)
                    {
                        window.location.href = '{{url('corporate/employee')}}'
                    }else {
                        alert(data.message)
                    }
                },
