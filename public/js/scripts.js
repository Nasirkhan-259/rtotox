		...
		if(_container_1.length > 0) {
			loadScript(plugin_path + 'bootstrap.datepicker/js/bootstrap-datepicker.min.js', function() {
				...
				if(jQuery().datepicker) {
					...
					var nowDate = new Date(nowTemp6.getFullYear(),nowTemp6.getMonth(),nowTemp6.getDate(),0,0,0,0);
					var datepickerList = [];

					_container_1.each(function(index) {
						var _t 		= jQuery(this),
						...
						console.log(nowDate)
						datepickerList.push(jQuery(this).datepicker({
							...
							if (typeof app.ChangeDate == 'function') {
								// AJAX POST - OPTIONAL
								const propertyName = _t.data("property-name");
								const propertyValue = _t.datepicker('getFormattedDate');
								app.ChangeDate(propertyName, propertyValue); // Vue app method
							}

							var a = new Date(ev.date);
							a.setDate(a.getDate() + 0);

							datepickerList[index].setValue(a);
							var next = index+1;
							datepickerList[next].element[0].focus();
